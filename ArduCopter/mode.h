...
class ModeMFC : public Mode {

public:
    public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::MFC; }
...
protected:
    ...
    const char *name() const override { return "MFC_MODE"; } // method for logging and display purposes
    const char *name4() const override { return "MFCN"; } // method for logging and display purposes
